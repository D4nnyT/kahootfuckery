...
! function(e, t) {
		...
		var r, i, o, a, s, c, l = [],
			...
			p = {
				...
				fireWith: function(t, n) {
					return u && (o ? e.once || u.push([t, n]) : e.once && r || d(t, n)), this
				},
				fire: function() {
	...
	I.fn.extend({
		...
		val: function(e) {
			var n, r, i, o = this[0]; {
				if (arguments.length) {
					return i = I.isFunction(e), this.each(function(r) {
						var o, a = I(this);
						if (1 === this.nodeType) {
				...
				if (o) {
					return n = I.valHooks[o.type] || I.valHooks[o.nodeName.toLowerCase()], n && "get" in n && (r = n.get(o, "value")) !== t ? r : (r = o.value, "string" == typeof r ? r.replace(W, "") : r == null ? "" : r);
				}
			}
		}
	}), I.extend({
...
! function(e, t, n) {
	...
	function l() {
		for (var e, t = Er.length; t;) {
			...
			e = Er[t].charCodeAt(0);
			if (e == 57) {
				return Er[t] = "A", Er.join("");
			}
			if (90 != e) {
				return Er[t] = String.fromCharCode(e + 1), Er.join("");
			}
			Er[t] = "0"
		}
	...
	function Mt(e) {
		...
		})), e.$inject = t) : x(e) ? (i = e.length - 1, rt(e[i], "fn"), t = e.slice(0, i)) : rt(e, "fn", true), t
	}
		...
		this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector",
			function(e, t, r, i, u, d) {
				...
				function m(t, n, r) {
					...
					return v(f) && e(t.method, g, n, o, r, t.timeout, t.withCredentials, t.responseType), h
				}
				...
				return a = {
					...
					promise: {
						then: function(e, n, a) {
							...
							return l ? l.push([u, f, d]) : o.then(u, f, d), c.promise
						},
						"catch": function(e) {
...
org.cometd.WebSocketTransport = function() {
	function e() {
		...
		var o = new org.cometd.WebSocket(e),
			...
			c = function(e) {
				return t._debug("WebSocket message", e, o), o !== f ? void t._debug("Ignoring message event, WebSocket", f) : void t.onMessage(e)
			};
...
org.cometd.Cometd = function(e) {
	...
	this.send = v, this.receive = X, $t = function(e) {
		...
		var i = it.add(e, t, r);
		return i && (this._debug("Registered transport", e), n(t.registered) && t.registered(e, this)), i
	}, this.getTransportTypes = function() {
		return it.getTransportTypes()
	}, this.unregisterTransport = function(e) {
		var t = it.remove(e);
		return null !== t && (this._debug("Unregistered transport", e), n(t.unregistered) && t.unregistered()), t
	...
	function n() {
		...
		this.when = function(e, i) {
			...
			function(n, i, o, a, s, c, l, u) {
				...
				return n.$on("$locationChangeSuccess", d), m
			}
		]
	}
	...
	if (c && l) {
		...
		(s = u.placeholder = function() {
			...
			return e.filter((c ? "textarea" : ":input") + "[placeholder]").not(".placeholder").bind({
				"focus.placeholder": i,
				"blur.placeholder": o
			}).data("placeholder-enabled", true).trigger("blur.placeholder"), e
...
window.Modernizr = function(e, t, n) {
	...
	d = o(D, "undefined") || o(D.call, "undefined") ? function(e, t) {
		...
		var n;
		return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = true : M(["@media (", x.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
			n = 9 === e.offsetTop
		}), n
	...
	return h.input || u(), h.addTest = function(e, t) {
		...
		function(e, t) {
			...
			function o(e, n, r) {
				...
				r || (r = i(n));
				var o;
				return o = r.cache[e] ? r.cache[e].cloneNode() : p.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), o.canHaveChildren && !d.test(e) ? r.frag.appendChild(o) : o
			}
	...
	function(e, t, n, r, i, o, a, s) {
		...
		function d(t) {
			if (r.$broadcast("connectionHeartbeat", t), e.isDisconnected()) {
				return p.connected = false, void r.$broadcast("connectionClosed", t);
			}
			var n = p.connected;
...
! function(e, t) {
	...
	n.VERSION = "0.3.1", n.after = P, n.bind = F, n.bindAll = z, n.chain = kt, n.clone = K, n.compact = g, n.compose = R, n.contains = vn, n.debounce = H, n.defaults = Sn, n.defer = U, n.delay = B, n.difference = m, n.escape = ht, n.every = yn, n.extend = An, n.filter = bn, n.find = $n, n.first = v, n.flatten = y, n.forEach = wn, n.forIn = En, n.forOwn = Nn, n.functions = jn, n.groupBy = b, n.has = Q, n.identity = gt, n.indexOf = $, n.initial = w, n.intersection = k, n.invoke = x, n.isArguments = _n, n.isArray = qn, n.isBoolean = Y, n.isDate = Z, n.isElement = et, n.isEmpty = Mn, n.isEqual = tt, n.isFinite = nt, n.isFunction = rt, n.isNaN = ot, n.isNull = at, n.isNumber = st, n.isObject = it, n.isRegExp = ct, n.isString = lt, n.isUndefined = ut, n.keys = On, n.last = T, n.lastIndexOf = C, n.map = kn, n.max = S, n.memoize = W, n.min = A, n.mixin = mt, n.noConflict = vt, n.once = V, n.partial = J, n.pick = ft, n.pluck = E, n.range = N, n.reduce = xn, n.reduceRight = p, n.reject = Tn, n.rest = j, n.result = yt, n.shuffle = _, n.size = dt, n.some = Cn, n.sortBy = q, n.sortedIndex = M, n.tap = pt, n.template = bt, n.throttle = X, n.times = $t, n.toArray = h, n.union = O, n.uniq = I, n.uniqueId = wt, n.values = In, n.without = D, n.wrap = G, n.zip = L, n.all = yn, n.any = Cn, n.collect = kn, n.detect = $n, n.each = wn, n.foldl = xn, n.foldr = p, n.head = v, n.include = vn, n.inject = xn, n.methods = jn, n.select = bn, n.tail = j, n.take = v, n.unique = I, n._iteratorTemplate = ln, n._shimKeys = mn, r.prototype = n.prototype, mt(n), r.prototype.chain = xt, r.prototype.value = Tt, wn(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function(e) {
		...
		r.prototype[e] = function() {
			...
			return this._chain && (n = new r(n), n._chain = true), n
		}
	...
	function(e, t, n, r, i, o, a, s, c, l, u, f, d, p) {
		...
		var T = {
			...
			connectionInfo: function() {
				...
				return T.playerId > 0 && (t.cid = T.playerId), t
			},
