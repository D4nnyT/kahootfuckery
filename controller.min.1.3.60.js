			...
			if (o.session.api) {
				...
				a.exists(n, function(t, r) {
					if (t) {
						...
						(r == 200 ? c() : (e.$broadcast("badGameId"), e.$broadcast("alert", {
							key: "invalidGameId",
...
function AnswerCtrl(e, t, n, r, i, o, a, s) {
	if (!r.ensureConnection()) {
		...
		e.selectedAnswerClass = function() {
			var t = "";
			e.selectedAnswer >= 0 && (t = "answer" + e.choices[e.selectedAnswer]);
			e.revealAnswer && (t += " hidden");
			return t;
		};
...
function GameOverCtrl(e, t, n, r, i, o, a, s) {
	...
	if (!n.ensureConnection()) {
		...
		t.shareWhat = o.quizTypes[e.quizType].showTitle ? "score" : "opinion";
		t.statusBarTitle = t.siteAppContent.info["game-pin"] + t.gameId;
...
! function(e, t) {
	...
	function o(e, t, n) {
		...
		!a || "queue" !== n && I._data(e, i) || "mark" !== n && I._data(e, o) || setTimeout(function() {
			I._data(e, i) || I._data(e, o) || (I.removeData(e, r, true), a.fire())
		}, 0)
	}
	...
	function m(e) {
		...
		if ("input" === t) {
			...
			"script" !== t && "undefined" != typeof e.getElementsByTagName && I.grep(e.getElementsByTagName("input"), g);
		}
	}
		...
		for (var f = (e === an); u > l && (f || !s); l++) {
			...
			if ("string" == typeof s) {
				if (!f || a[s]) {
					...
					(n.dataTypes.unshift(s), s = $(e, n, r, i, s, a));
				}
			}
		}!f && s || a["*"] || (s = $(e, n, r, i, "*", a));
		return s;
						...
						if (i[1]) {
							...
							if (a) {
								if (s.isPlainObject(n)) {
									(e = [q.createElement(a[1])], s.fn.attr.call(e, n, true));
								} else {
									e = [c.createElement(a[1])];
								}
							} else {
								(a = s.buildFragment([i[1]], [c]), e = (a.cacheable ? s.clone(a.fragment) : a.fragment).childNodes);
							}
						...
						for (n in e) {
							...
							if (c !== i) {
								if (f && i && (s.isPlainObject(i) || (o = s.isArray(i)))) {
									(o ? (o = false, a = r && s.isArray(r) ? r : []) : a = r && s.isPlainObject(r) ? r : {}, c[n] = s.extend(f, a, i));
								} else {
									i !== t && (c[n] = i);
								}
							}
			...
			s.extend({
				...
				ready: function(e) {
					if (e === true && !--s.readyWait || e !== true && !s.isReady) {
						...
						if (s.isReady = true, e !== true && --s.readyWait > 0) return;
				...
				parseXML: function(n) {
					...
					r && r.documentElement && !r.getElementsByTagName("parsererror").length || s.error("Invalid XML: " + n);
					return r;
				},
				noop: function() {},
				...
				sub: function() {
					...
					s.extend(true, e, this), e.superclass = this, e.fn = e.prototype = this(), e.fn.constructor = e, e.sub = this.sub, e.fn.init = function(n, r) {
		...
		var r, i, o, a, s, c, l = [],
			...
			p = {
				...
				fireWith: function(t, n) {
					u && (o ? e.once || u.push([t, n]) : e.once && r || d(t, n));
					return this;
				},
				fire: function() {
	...
	I.extend({
			...
			if (I.acceptData(e)) {
				...
				if (l[u]) {
					...
					if ((n || (delete l[u].data, i(l[u])))) {
						...
						c && (I.support.deleteExpando ? delete e[s] : e.removeAttribute ? e.removeAttribute(s) : e[s] = null);
					}
				}
			}
		},
		...
		_unmark: function(e, t, n) {
			...
			if (t) {
				...
				if (i) {
					...
					(I.removeData(t, r, true), o(t, n, "mark"));
				}
			}
		},
		...
		queue: function(e, n) {
			...
			return arguments.length < r ? I.queue(this[0], e) : n === t ? this : this.each(function() {
	...
	I.fn.extend({
		...
		toggleClass: function(e, t) {
			...
			return this.each(I.isFunction(e) ? function(n) {
				...
				if ("string" === n)
					...
					this.className = this.className || e === false ? "" : I._data(this, "__className__") || "";
				}
			})
		},
		hasClass: function(e) {
		...
		val: function(e) {
			var n, r, i, o = this[0]; {
						...
						if (1 === this.nodeType) {
							...
							if (o == null) {
								...
								if ("number" == typeof o) {
									...
									I.isArray(o) && (o = I.map(o, function(e) {
										return e == null ? "" : e + ""
									}));
								}
							}
				...
				if (o) {
					...
					return n && "get" in n && (r = n.get(o, "value")) !== t ? r : (r = o.value, "string" == typeof r ? r.replace(W, "") : r == null ? "" : r);
				}
			}
		}
	}), I.extend({
		...
		attr: function(e, n, r, i) {
			...
			if (e && 3 !== c && 8 !== c && 2 !== c) {
				return i && n in I.attrFn ? I(e)[n](r) : "undefined" == typeof e.getAttribute ? I.prop(e, n, r) : (s = 1 !== c || !I.isXMLDoc(e), s && (n = n.toLowerCase(), a = I.attrHooks[n] || (G.test(n) ? R : z)), r !== t ? null === r ? void I.removeAttr(e, n) : a && "set" in a && s && (o = a.set(e, r, n)) !== t ? o : (e.setAttribute(n, "" + r), r) : a && "get" in a && s && null !== (o = a.get(e, n)) ? o : (o = e.getAttribute(n), null === o ? t : o));
			}
		},
		...
		attrHooks: {
			...
			value: {
				get: function(e, t) {
					return z && I.nodeName(e, "button") ? z.get(e, t) : t in e ? e.value : null
				},
				set: function(e, t, n) {
					return z && I.nodeName(e, "button") ? z.set(e, t, n) : void(e.value = t)
				}
			}
		},
		propFix: {
		...
		prop: function(e, n, r) {
			...
			if (e && 3 !== s && 8 !== s && 2 !== s) {
				a = 1 !== s || !I.isXMLDoc(e);
				a && (n = I.propFix[n] || n, o = I.propHooks[n]);
		...
		get: function(e, n) {
			...
			return r && (H[n] ? "" !== r.nodeValue : r.specified) ? r.nodeValue : t;
		},
		set: function(e, t, n) {
	...
	}, I.attrHooks.tabindex.set = z.set, I.each(["width", "height"], function(e, t) {
	...
	I.event = {
		add: function(e, n, r, i, o) {
			...
			if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = I._data(e))) {
				...
				}, s.elem = e), n = I.trim(at(n)).split(" "), l = 0; l < n.length; l++) u = Y.exec(n[l]) || [], f = u[1], d = (u[2] || "").split(".").sort(), m = I.event.special[f] || {}, f = (o ? m.delegateType : m.bindType) || f, m = I.event.special[f] || {}, p = I.extend({
					type: f,
					origType: u[1],
					data: i,
					handler: r,
				...
				for (o = 0; o < t.length; o++)
					if (a = Y.exec(t[o]) || [], s = c = a[1], l = a[2], s) {
						...
						if (0 === g.length && u !== g.length) {
							p.teardown && p.teardown.call(e, l) !== false || I.removeEvent(e, s, v.handle);
							delete d[s];
						}
					} else
				...
				if (!nt.test(m + I.event.triggered) && (m.indexOf("!") >= 0 && (m = m.slice(0, -1), s = true), m.indexOf(".") >= 0 && (v = m.split("."), m = v.shift(), v.sort()), i && !I.event.customEvent[m] || I.event.global[m]))
					if (n = "object" == typeof n ? n[I.expando] ? n : new I.Event(m, n) : new I.Event(m), n.type = m, n.isTrigger = true, n.exclusive = s, n.namespace = v.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.)?") + "(\\.|$)") : null, f = m.indexOf(":") < 0 ? "on" + m : "", i) {
						...
						if (!d.trigger || d.trigger.apply(i, r) !== false) {
							...
							n.type = m;
							o || n.isDefaultPrevented() || d._default && d._default.apply(i.ownerDocument, r) !== false || "click" === m && I.nodeName(i, "a") || !I.acceptData(i) || f && i[m] && ("focus" !== m && "blur" !== m || 0 !== n.target.offsetWidth) && !I.isWindow(i) && (u = i[f], u && (i[f] = null), I.event.triggered = m, i[m](), I.event.triggered = t, u && (i[f] = u));
							return n.result;
						}
					} else {
						a = I.cache;
		...
		dispatch: function(n) {
			...
			if (!v.preDispatch || v.preDispatch.call(this, n) !== false) {
				...
				v.postDispatch && v.postDispatch.call(this, n);
				return n.result;
			}
		},
		...
		mouseHooks: {
			...
			filter: function(e, n) {
				var r, i, o, a = n.button,
					s = n.fromElement;
				null == e.pageX && null != n.clientX && (r = e.target.ownerDocument || q, i = r.documentElement, o = r.body, e.pageX = n.clientX + (i && i.scrollLeft || o && o.scrollLeft || 0) - (i && i.clientLeft || o && o.clientLeft || 0), e.pageY = n.clientY + (i && i.scrollTop || o && o.scrollTop || 0) - (i && i.clientTop || o && o.clientTop || 0));
		...
		I.event.special[e] = {
			...
			handle: function(e) {
				...
				(!i || i !== r && !I.contains(r, i)) && (e.type = o.origType, n = o.handler.apply(this, arguments), e.type = t);
				return n;
			}
		}
		...
		postDispatch: function(e) {
			if (e._submit_bubble) {
				...
				this.parentNode && !e.isTrigger && I.event.simulate("submit", this.parentNode, e, true);
			}
		},
		teardown: function() {
		...
		off: function(e, n, r) {
			...
			(n === false || "function" == typeof n) && (r = n, n = t);
			r === false && (r = a);
			return this.each(function() {
		...
		triggerHandler: function(e, t) {
			return this[0] ? I.event.trigger(e, t, this[0], true) : void 0
		},
		toggle: function(e) {
			var t = arguments,
				n = e.guid || I.guid++,
	...
	function() {
		...
		var d = function(e, t, n, i) {
			...
			if (w.length > 1 && g.exec(e))
				if (2 === w.length && h.relative[w[0]]) c = k(w[0] + w[1], t, i);
					...
					for (c = h.relative[w[0]] ? [t] : d(w.shift(), t); w.length;) e = w.shift(), h.relative[e] && (e += w.shift()), c = k(e, c, i);
		...
		d.uniqueSort = function(e) {
			...
			r || (r = "undefined" != typeof t.getElementsByTagName ? t.getElementsByTagName("*") : []);
			return {
				set: r,
				expr: e
			};
		...
		q.documentElement.compareDocumentPosition ? $ = function(e, t) {
			return e === t ? (s = true, 0) : e.compareDocumentPosition && t.compareDocumentPosition ? 4 & e.compareDocumentPosition(t) ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
		} : ($ = function(e, t) {
			if (e === t) {
				s = true;
				return 0;
		...
		}(), d.contains = q.documentElement.contains ? function(e, t) {
	...
	I.fn.extend({
		...
		filter: function(e, t, n) {
			n && (e = ":not(" + e + ")");
			return 1 === t.length ? I.find.matchesSelector(t[0], e) ? [t[0]] : [] : I.find.matches(e, t);
		},
		dir: function(e, n, r) {
	...
	At.optgroup = At.option, At.tbody = At.tfoot = At.colgroup = At.caption = At.thead, At.th = At.td, I.support.htmlSerialize || (At._default = [1, "div<div>", "</div>"]), I.fn.extend({
		...
		html: function(e) {
			return I.access(this, function(e) {
				var n = this[0] || {},
					...
					i = this.length;
				if (e === t) {
					return 1 === n.nodeType ? n.innerHTML.replace(gt, "") : null;
				}
		...
		domManip: function(e, n, r) {
			...
			if (this[0]) {
				s = c && c.parentNode;
				i = I.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {
					fragment: s
				} : I.buildFragment(e, this, l);
				a = i.fragment;
	...
	I.fn.css = function(e, n) {
		...
		style: function(e, n, r, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				if (n = I.cssProps[s] || s, r === t) {
					return l && "get" in l && (o = l.get(e, false, i)) !== t ? o : c[n];
				}
				a = typeof r;
				"string" === a && (o = Lt.exec(r)) && (r = +(o[1] + 1) * +o[2] + parseFloat(I.css(e, n)), a = "number");
		...
		(r = e.ownerDocument.defaultView) && (i = r.getComputedStyle(e, null)) && (n = i.getPropertyValue(t), "" !== n || I.contains(e.ownerDocument.documentElement, e) || (n = I.style(e, t)));
		!I.support.pixelMargin && i && Pt.test(t) && Dt.test(n) && (o = a.width, a.width = n, n = i.width, a.width = o);
		return n;
	}), q.documentElement.currentStyle && (_t = function(e, t) {
		var n, r, i, o = e.currentStyle && e.currentStyle[t],
			a = e.style;
		o == null && a && (i = a[t]) && (o = i);
		Dt.test(o) && (n = a.left, r = e.runtimeStyle && e.runtimeStyle.left, r && (e.runtimeStyle.left = e.currentStyle.left), a.left = "fontSize" === t ? "1em" : o, o = a.pixelLeft + "px", a.left = n, r && (e.runtimeStyle.left = r));
		return "" === o ? "auto" : o;
		...
		I.cssHooks[e + t] = {
			expand: function(n) {
				var r, i = "string" == typeof n ? n.split(" ") : [n],
					o = {};
				for (r = 0; 4 > r; r++) o[e + zt[r] + t] = i[r] || i[r - 2] || i[0];
				return o
			}
		}
	});
	...
	I.fn.extend({
		load: function(e, n, r) {
			...
			if (n) {
				if (I.isFunction(n)) {
					...
					"object" == typeof n && (n = I.param(n, I.ajaxSettings.traditional), a = "POST");
				}
			}
			var s = this;
			I.ajax({
		...
		ajax: function(e, n) {
			function r(e, n, r, a) {
				if (2 !== w) {
					...
					if (e >= 200 && 300 > e || 304 === e)
						if (d.ifModified && ((b = k.getResponseHeader("Last-Modified")) && (I.lastModified[i] = b), ($ = k.getResponseHeader("Etag")) && (I.etag[i] = $)), 304 === e) C = "notmodified", l = true;
						else try {
							f = T(d, S);
							C = "success";
							l = true;
			...
			if (s = $(sn, d, n, k)) {
				k.readyState = 1, u && h.trigger("ajaxSend", [k, d]), d.async && d.timeout > 0 && (c = setTimeout(function() {
					k.abort("timeout")
				}, d.timeout));
				try {
					w = 1, s.send(y, r)
					...
					c.send(n.hasContent && n.data || null), r = function(e, i) {
						...
						try {
							if (r && (i || 4 === c.readyState)) {
								r = t;
								a && (c.onreadystatechange = I.noop, pn && delete dn[a]);
								if (i)
									if (4 !== c.readyState) {
										c.abort();
									} else {
			...
			this.startTime = yn || A(), this.end = n, this.now = this.start = e, this.pos = this.state = 0, this.unit = r || this.unit || (I.cssNumber[this.prop] ? "" : "px"), i.queue = this.options.queue, i.elem = this.elem, i.saveState = function() {
				if (I._data(o.elem, "fxshow" + o.prop) === t) {
					if (o.options.hide) {
						...
						o.options.show && I._data(o.elem, "fxshow" + o.prop, o.end);
					}
				}
	...
	xn = "getBoundingClientRect" in q.documentElement ? function(e, t, n, r) {
		...
		("relative" === c.position || "static" === c.position) && (l += a.offsetTop, u += a.offsetLeft);
		I.support.fixedPosition && "fixed" === c.position && (l += Math.max(n.scrollTop, a.scrollTop), u += Math.max(n.scrollLeft, a.scrollLeft));
		return {
			top: l,
			left: u
		};
		...
		bodyOffset: function(e) {
			var t = e.offsetTop,
				n = e.offsetLeft;
			I.support.doesNotIncludeMarginInBodyOffset && (t += parseFloat(I.css(e, "marginTop")) || 0, n += parseFloat(I.css(e, "marginLeft")) || 0);
			return {
				top: t,
				left: n
			};
		...
		setOffset: function(e, t, n) {
			...
			var i, o, a = I(e),
				...
				f = {},
				d = {};
			u ? (d = a.position(), i = d.top, o = d.left) : (i = parseFloat(c) || 0, o = parseFloat(l) || 0), I.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (f.top = t.top - s.top + i), null != t.left && (f.left = t.left - s.left + o), "using" in t ? t.using.call(e, f) : a.css(f)
		}
	}, I.fn.extend({
		position: function() {
			if (!this[0]) {
...
! function(e, t, n) {
			...
			if (!r || null != e)
				for (; d.length;)
					for (i = d.shift(), a = 0, s = i.length; s > a; a++)
						for (c = br(i[a]), p ? c.triggerHandler("$destroy") : p = !p, l = 0, u = (f = c.children()).length; u > l; l++) d.push($r(f[l]));
	...
	function ht(e, n) {
		n = n || t;
		var r;
		return (r = zr.exec(e)) ? [n.createElement(r[1])] : pt(e, n)
	}
	...
	function Lt(e, t, r, i) {
		...
		l.onUrlChange = function(t) {
			A || (i.history && br(e).on("popstate", c), i.hashchange ? br(e).on("hashchange", c) : l.addPollFn(c), A = true);
			S.push(t);
			return t;
		}, l.baseHref = function() {
			var e = T.attr("href");
		...
		l.cookies = function(e, t) {
			...
			if (t === n) {
				...
				$(t) && (i = (u.cookie = escape(e) + "=" + escape(t) + ";path=" + j).length + 1, i > 4096 && r.warn("Cookie '" + e + "' possibly not set or overflowed because it was too large (" + i + " > 4096 bytes)!"));
			}
			...
			function(e, r, c, d, h, v, y, w, k, C, S, A) {
				...
				function j(e, t, r, i, o, a) {
					function s(e, r, i, o) {
						var a, s, c, l, u, f, d, p, g, m = r.length,
							v = new Array(m);
						for (d = 0; m > d; d++) v[d] = r[d];
						for (d = 0, g = 0, p = h.length; p > d; g++) c = v[g], a = h[d++], s = h[d++], l = br(c), a ? (a.scope ? (u = e.$new(), l.data("$scope", u)) : u = e, f = a.transclude, f || !o && t ? a(s, u, c, i, _(e, f || t)) : a(s, u, c, i, o)) : s && s(e, c.childNodes, n, o)
					}
						...
						case 1:
							...
							for (var f, d, p, h, g, m = e.attributes, v = 0, y = m && m.length; y > v; v++) {
								...
								if (f = m[v], !yr || yr >= 8 || f.specified) {
									...
									h === k + "Start" && (b = d, w = d.substr(0, d.length - 5) + "end", d = d.substr(0, d.length - 6)), p = Ht(d.toLowerCase()), u[p] = d, n[p] = g = Nr(f.value), Nt(e, p) && (n[p] = true), G(e, t, g, p), F(t, p, "A", r, i, b, w)
								}
							}
				...
				function I(e, i, a, s, l, u, f, d, p) {
					function h(e, t, n, r) {
						e && (n && (e = O(e, n, r)), e.require = k.require, (F === k || k.$$isolateScope) && (e = Q(e, {
							isolateScope: true
						})), f.push(e)), t && (n && (t = O(t, n, r)), t.require = k.require, (F === k || k.$$isolateScope) && (t = Q(t, {
							isolateScope: true
						})), d.push(t))
					}
					...
					function m(e, t, s, l, u) {
						function p(e, t) {
							var r;
							arguments.length < 2 && (t = e, e = n);
							X && (r = C);
							return u(e, t, r);
						}
						var h, m, b, $, w, k, x, T, C = {};
						h = i === s ? a : D(a, new Y(br(s), a.$attr));
						m = h.$$element;
						if (F) {
							var S = /^\s*([@=&])(\??)\s*(\w*)\s*$/,
								A = br(s);
							x = t.$new(true), R && R === F.$$originalDirective ? A.data("$isolateScope", x) : A.data("$isolateScopeNoTemplate", x), N(A, "ng-isolate-scope"), o(F.scope, function(e, n) {
				...
				function H(e, t) {
					...
					o(e, function(r, i) {
						...
						if (o == "class") {
							(N(i, t), e["class"] = (e["class"] ? e["class"] + " " : "") + t);
						} else {
							if (o == "style") {
								(i.attr("style", i.attr("style") + ";" + t), e.style = (e.style ? e.style + ";" : "") + t);
							} else {
				...
				function B(e, t, n, r, i, a, s, c) {
					...
					d.get(C.getTrustedResourceUrl(y), {
						...
						for (e.unshift(v), l = I(e, d, n, i, t, m, a, s, c), o(r, function(e, n) {
							...
							if (T !== g) {
								var E = T.className;
								c.hasElementTranscludeDirective && m.replace || (A = mt(d)), K(C, br(T), A), N(br(A), E)
							}
				...
				function K(e, n, r) {
					...
					for (var p = 1, h = n.length; h > p; p++) {
						var g = n[p];
						br(g).remove(), d.appendChild(g), delete n[p]
					}
					n[0] = r, n.length = 1
				}
	...
	function Ut() {
		...
		this.register = function(t, n) {
			it(t, "controller"), b(t) ? f(e, t) : e[t] = n
			...
			function(n, i) {
				return function(o, a) {
					...
					if ($(o)) {
						...
						l = c[1];
						u = c[3];
						o = e.hasOwnProperty(l) ? e[l] : ot(a.$scope, l, true) || ot(i, l, true);
						rt(o, l, true);
					}
					s = n.instantiate(o, a);
					if (u) {
		...
		var e = /^\s*(\[|\{[^\{])/,
			...
			a = this.defaults = {
				transformResponse: [
					...
					function(n) {
						$(n) && (n = n.replace(r, ""), e.test(n) && t.test(n) && (n = U(n)));
						return n;
					}
				],
				transformRequest: [
		...
		this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector",
			function(e, t, r, i, u, d) {
				function p(e) {
					...
					function i(e) {
						...
						var n, r, i, s = a.headers,
							c = f({}, e.headers);
						s = f({}, s.common, s[pr(e.method)]), t(s), t(c);
						e: for (n in s) {
							r = pr(n);
							for (i in c)
				...
				function m(t, n, r) {
					...
					function s(e, n, r, i) {
						n = Math.max(n, 0), (Kt(n) ? d.resolve : d.reject)({
							data: e,
							status: n,
							headers: Xt(r),
							config: t,
					...
					h.then(c, c);
					(t.cache || a.cache) && t.cache !== false && "GET" == t.method && (l = b(t.cache) ? t.cache : b(a.cache) ? a.cache : k);
					if (l)
						if (f = l.get(g), y(f)) {
							if (f.then) {
								f.then(c, c);
					...
					v(f) && e(t.method, g, n, o, r, t.timeout, t.withCredentials, t.responseType);
					return h;
				}
	...
	function an(e, t, n) {
		var r = Fn(e, n);
		t.$$protocol = r.protocol, t.$$host = r.hostname, t.$$port = d(r.port) || oi[r.protocol] || null
	}
	...
	function pn(e, t) {
		...
		an(e, this, e), this.$$parse = function(r) {
			function i(e, t, n) {
				...
				return i.exec(t) ? e : (r = i.exec(e), r ? r[1] : e);
			}
			var o = cn(e, r) || cn(n, r),
		...
		this.hashPrefix = function(e) {
			...
			function(r, i, o, a) {
				...
				var c, l, u, f = i.baseHref(),
					d = i.url();
				n ? (u = fn(d) + (f || "/"), l = o.history ? dn : hn) : (u = ln(d), l = pn), c = new l(u, "#" + t), c.$$parse(c.$$rewrite(d)), a.on("click", function(t) {
					if (!t.ctrlKey && !t.metaKey && 2 != t.which) {
						...
						if (o && !n.attr("target") && s && !t.isDefaultPrevented()) {
							t.preventDefault();
							s != i.url() && (c.$$parse(s), r.$apply(), e.angular["ff-684208-preventDefault"] = true);
						}
					}
				...
				r.$watch(function() {
					var e = i.url(),
						t = c.$$replace;
					p && e == c.absUrl() || (p++, r.$evalAsync(function() {
	...
	function En(e, t) {
		...
		var s = function() {
			...
			f = function(n, o, a, u) {
				...
				e(function() {
					c(n).then(function(e) {
						f || (f = true, d.resolve(c(e).then(p, h, g)))
					}, function(e) {
						f || (f = true, d.resolve(h(e)))
					}, function(e) {
						f || d.notify(g(e))
					})
				});
	...
	function In() {
		...
		this.resourceUrlWhitelist = function(t) {
			arguments.length && (e = On(t));
			return e;
		}, this.resourceUrlBlacklist = function(e) {
			arguments.length && (t = On(e));
			return t;
		}, this.$get = ["$injector",
			function(r) {
				function i(e, t) {
	...
	function Fn(e) {
		var t = e;
		yr && (vi.setAttribute("href", t), t = vi.href);
	...
	function ar(e, t, n, i, o, a) {
		...
		if (g) {
			...
			h = g.match(/^\/(.*)\/([gim]*)$/);
			if (h) {
				(g = new RegExp(h[1], h[2]), p = function(e) {
					return m(g, e)
				});
			} else {
				p = function(n) {
			...
			function(n) {
				...
				return {
					...
					link: function(a, s, c) {
						...
						var h;
						a.$watch(c[e], p, true), c.$observe("class", function() {
							p(a.$eval(c[e]))
	...
	var Wr = gt.prototype = {
			ready: function(n) {
				...
				if ("complete" === t.readyState) {
					...
					(this.on("DOMContentLoaded", r), gt(e).on("load", r));
				}
			},
			toString: function() {
				var e = [];
	...
	o("input,select,option,textarea,button,form,details".split(","), function(e) {
		...
		css: function(e, t, r) {
			if (t = ut(t), !y(r)) {
				var i;
				8 >= yr && (i = e.currentStyle && e.currentStyle[t], "" === i && (i = "auto"));
				i = i || e.style[t];
				8 >= yr && (i = "" === i ? n : i);
				return i;
			}
		...
		attr: function(e, t, r) {
			...
			if (Vr[i]) {
				...
				if (r) {
					(e[t] = true, e.setAttribute(t, i));
				} else {
					(e[t] = false, e.removeAttribute(i));
				}
	...
	pi.ZERO = f(function() {
		...
		primary: function() {
			...
			if (this.expect("(")) e = this.filterChain(), this.consume(")");
				...
				var t = this.expect();
				e = t.fn, e || this.throwError("not a primary expression", t), t.json && (e.constant = true, e.literal = true)
			}
		...
		logicalAND: function() {
			...
			(e = this.expect("&&")) && (t = this.binaryFn(t, e.fn, this.logicalAND()));
			return t;
		},
		equality: function() {
			var e, t = this.relational();
			(e = this.expect("==", "!=", "===", "!==")) && (t = this.binaryFn(t, e.fn, this.equality()));
			return t;
		},
		relational: function() {
			var e, t = this.additive();
			(e = this.expect("<", ">", "<=", ">=")) && (t = this.binaryFn(t, e.fn, this.relational()));
			return t;
		},
		additive: function() {
	...
	var Ci = m({
			...
			compile: function(e, n) {
				8 >= yr && (n.href || n.name || n.$set("href", ""), e.append(t.createComment("IE fix")));
				return n.href || n.xlinkHref || n.name ? void 0 : function(e, t) {
				...
				return {
					...
					link: function(r, i, a) {
						...
						o(a, function(e, t) {
							...
							return isNaN(t) ? "" : (t in u || (t = e.pluralCat(t - l)), f[t](r, i, true))
						}, function(e) {
							i.text(e)
						})
					}
					...
					controller: ["$element", "$scope", "$attrs",
						function(e, t, n) {
							...
							o.databound = n.ngModel, o.init = function(e, t, n) {
								...
								if (this.hasOption(e)) {
									delete a[e];
									e == c.$viewValue && this.renderUnknownOption(e);
								}
						...
						function p(t, o, s) {
							function c() {
								...
								if (b)
									if (v && x(I)) {
										F = new qt([]);
										for (var z = 0; z < I.length; z++) P[f] = I[z], F.put(v(t, P), I[z])
									} else F = new qt(I);
			...
			t.xhr = this.xhrSend({
				...
				onSuccess: function(i) {
					...
					try {
						...
						if (0 === a.length) {
							(n = false, r.transportFailure(e, t, "no response", null));
						} else {
							(o = true, r.transportSuccess(e, t, a));
						}
					} catch (s) {
	...
	function e() {
		...
		var o = new org.cometd.WebSocket(e),
			a = function() {
				...
				n && (t.clearTimeout(n), n = null);
				return o !== f ? void t._debug("Ignoring open event, WebSocket", f) : void t.onOpen();
			},
			s = function(e) {
				var r = e ? e.code : 1e3,
					i = e ? e.reason : void 0;
				...
				n && (t.clearTimeout(n), n = null);
				return o !== f ? void t._debug("Ignoring close event, WebSocket", f) : void t.onClose(r, i);
			},
			c = function(e) {
				t._debug("WebSocket message", e, o);
				return o !== f ? void t._debug("Ignoring message event, WebSocket", f) : void t.onMessage(e);
			};
		o.onopen = a, o.onclose = s, o.onerror = function() {
			s({
				code: 1002
			})
		}, o.onmessage = c, f = o, this._debug("Transport", this.getType(), "configured callbacks on", o)
	}
				...
				onSuccess: function(e) {
					...
					try {
						...
						if (0 === i.length) {
							...
							(n = true, r.transportSuccess(u, t, i));
						}
					} catch (o) {
						r._debug(o), n || r.transportFailure(u, t, "bad response", o)
					}
				},
...
org.cometd.RequestTransport = function() {
	function e(e) {
		for (; f.length > 0;) {
			...
			f.shift(), e.messages = e.messages.concat(n.messages), this._debug("Coalesced", n.messages.length, "messages from request", r.id)
		}
	}
	...
	function n(e) {
		...
		if (u.length < this.getConfiguration().maxConnections - 1) {
			(u.push(r), t.call(this, e, r));
		} else {
			(this._debug("Transport", this.getType(), "queueing request", n, "envelope", e), f.push([e, r]));
		}
	}
...
org.cometd.TransportRegistry = function() {
	...
	this.getTransportTypes = function() {
		...
		o || ("number" != typeof i ? e.push(n) : e.splice(i, 0, n), t[n] = r);
		return !o;
...
org.cometd.Cometd = function(e) {
	...
	function h() {
		null !== pt && org.cometd.Utils.clearTimeout(pt), pt = null
	}
	...
	function m(e, t, r, i) {
		for (var o = 0; o < t.length; ++o) {
			...
			var s = void 0;
			n(a._callback) && (s = a._callback, delete a._callback), a = f(a), void 0 !== a && null !== a ? (t[o] = a, s && (mt[a.id] = s)) : t.splice(o--, 1)
		}
		if (0 !== t.length) {
			var l = bt.url;
	...
	function P(e) {
		p("/meta/subscribe", e), p("/meta/unsuccessful", e)
	}
	...
	function R(e) {
		p("/meta/unsubscribe", e), p("/meta/unsuccessful", e)
	}
	...
	function K(e, r) {
		...
		if (n(e)) i.scope = void 0, i.method = e;
		else if (t(r)) {
	...
	this.send = v, this.receive = X, $t = function(e) {
		...
		var i = it.add(e, t, r);
		i && (this._debug("Registered transport", e), n(t.registered) && t.registered(e, this));
		return i;
	}, this.getTransportTypes = function() {
		return it.getTransportTypes()
	}, this.unregisterTransport = function(e) {
		var t = it.remove(e);
		null !== t && (this._debug("Unregistered transport", e), n(t.unregistered) && t.unregistered());
		return t;
			...
			this.registered = function(e, t) {
				...
				if (t && 0 === t.indexOf("/meta/") && e.ext && e.ext.timesync) {
					...
					var l = (new Date).getTime(),
						u = (l - r.tc - r.p) / 2,
						f = r.ts - r.tc - u;
					o.push(u), a.push(f), a.length > i && (a.shift(), o.shift());
					for (var d = a.length, p = 0, h = 0, g = 0; d > g; ++g) p += o[g], h += a[g];
					s = parseInt((p / d).toFixed()), c = parseInt((h / d).toFixed()), n("TimeSyncExtension: network lag", s, "ms, time offset with server", c, "ms", s, c)
				}
				return e
			}, this.outgoing = function(t) {
				var r = t.channel;
				r && 0 === r.indexOf("/meta/") && (t.ext || (t.ext = {}), t.ext.timesync = {
					tc: (new Date).getTime(),
					l: s,
					o: c
	...
	t.module("ngCookies", ["ng"]).factory("$cookies", ["$rootScope", "$browser",
		function(e, r) {
			function i() {
				...
				for (e in a) {
					i = a[e];
					t.isString(i) || (i = "" + i, a[e] = i);
					i !== s[e] && (r.cookies(e, i), c = true);
				}
				if (c) {
					c = false, o = r.cookies();
					for (e in a)
			...
			function u(s, c, v) {
				...
				p(v, function(i, s) {
					...
					$[s] = function(s, l, u, f) {
						...
						return C ? j : (S.$promise = j, S.$resolved = false, S);
...
! function(e, t) {
	...
	function i(e) {
		var t, n = {},
			r = e.split(",");
		for (t = 0; t < r.length; t++) n[r[t]] = true;
		return n
	}
	...
	function a(e) {
		...
		var t = j.exec(e),
			...
			r = t[3],
			i = t[2];
		i && (N.innerHTML = i.replace(/</g, "&lt;"), i = "textContent" in N ? N.textContent : N.innerText);
		return n + i + r;
	}
		...
		return {
			start: function(e, o, a) {
				e = t.lowercase(e), !r && C[e] && (r = e), r || S[e] !== true || (i("<"), i(e), t.forEach(o, function(r, o) {
					...
					E[a] !== true || A[a] === true && !n(r, c) || (i(" "), i(o), i('="'), i(s(r)), i('"'))
				}), i(a ? "/>" : ">"))
			},
			end: function(e) {
	...
	t.module("ngSanitize", []).provider("$sanitize", n), t.module("ngSanitize").filter("linky", ["$sanitize",
		function(e) {
			...
			return function(o, a) {
				...
				for (var l, u, f, d = o, p = []; l = d.match(n);) u = l[0], l[2] == l[3] && (u = "mailto:" + u), f = l.index, s(d.substr(0, f)), c(u, l[0].replace(i, "")), d = d.substring(f + l[0].length);
				s(d);
				return e(p.join(""));
			}
		}
...
window.Modernizr = function(e, t, n) {
	...
	function c(e, t, r) {
		for (var i in e) {
			var a = t[e[i]];
			if (a !== n) {
				return r === false ? e[i] : o(a, "function") ? a.bind(r || t) : a;
			}
		}
		return false
	}
	...
	d = o(D, "undefined") || o(D.call, "undefined") ? function(e, t) {
		...
		var e = !!l("perspective");
		e && "webkitPerspective" in m.style && M("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(t) {
	...
	return h.input || u(), h.addTest = function(e, t) {
		...
		function(e, t) {
			...
			function o(e, n, r) {
				...
				r || (r = i(n));
				var o;
				o = r.cache[e] ? r.cache[e].cloneNode() : p.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e);
			...
			function c(e) {
				e || (e = t);
				var r = i(e);
				v.shivCSS && !l && !r.hasCSS && (r.hasCSS = !!n(e, "article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#FF0;color:#000}"));
				u || s(e, r);
				return e;
			}
			var l, u, f = e.html5 || {},
...
var addToHome = function(e) {
	...
	function s() {
		...
		return k ? void(5 > g && k && (w = setInterval(c, E.iterations))) : (b.parentNode.removeChild(b), void(b = null));
	}
...
! function(e) {
	e("sanitize", function(e, t) {
		...
		void 0 !== t && (t.allowedTags = n.allowedTags, t.characterCount = n.characterCount, t.removeDangerousTags = n.removeDangerousTags, t.escapeTags = n.escapeTags, t.stripTags = n.stripTags, t.plainText = n.plainText, t.escapeEntities = n.escapeEntities, t.wysiwigEncode = n.wysiwigEncode);
		return n;
	})
	...
	if ("undefined" != typeof exports) {
		...
		(window.mobitroll = window.mobitroll || {}, t(function(e) {
			return window[e]
...
angular.module("app.services.network", ["underscore", "app.services.comet"]).factory("$network", ["$config", "$log", "_", "$comet", "$timeout", "$rootScope",
	function(e, t, n, r, i, o) {
		...
		function s() {
			...
			u || (f = o.$on("messageRecieved", e), d = o.$on("connectionHeartbeat", e))
		}
...
angular.module("app.services.mobitroll", ["app.services.comet", "app.services.comet-ack", "app.services.comet-timesync", "ngCookies"]).factory("$mobitroll", ["$comet", "$config", "$location", "$rootScope", "$log", "$cookieStore", "$window", "$timeout", "$comet-ack", "$comet-timesync",
	function(e, t, n, r, i, o, a, s) {
		function c(e) {
			if (e.successful) {
				(p.handshaked = true, r.$broadcast("handshakeSuccess", e));
			} else {
		...
		var p = {
			...
			connect: function(t) {
				o.put("no.mobitroll.session", t), s(function() {
					var t = p;
					t.handshaked || (e.addListener("/meta/handshake", c), e.addListener("/meta/connect", d), e.addListener("/meta/subscribe", f), e.addListener("/meta/unsuccessful", l), e.handshake())
				}, 50)
			},
			disconnect: function() {
...
angular.module("app.services.random", []).factory("$random", [
	...
	function() {
		...
		function t() {
			for (var e = p.g(c), t = f, n = 0; l > e;) e = (e + n) * s, t *= s, n = p.g(1);
			for (; e >= u;) e /= 2, t /= 2, n >>>= 1;
			return (e + n) / t
		}
...
angular.module("app.services.ios7fixes", ["ng"]).factory("$ios7fixes", ["$window",
	function(e) {
		e.navigator.userAgent.match(/iPad;.*CPU.*OS 7_\d/i) && $("html").addClass("ipad ios7");
		e.navigator.userAgent.indexOf("CriOS") >= 0 && $("html").addClass("chromeios");
		e.navigator.standalone && $("html").addClass("standalone");
		return null;
	}
]);
	...
	function(e, t) {
		function n() {
			...
			if (-1 == e.toLowerCase().indexOf("token")) {
				t._gaq && t._gaq.push(["_trackPageview", e]);
				t.ga && t.ga("send", "pageview", e);
			}
		}
		...
		return {
			link: function(r, i, o) {
				function a(e, t) {
					...
					var a = $("p", i[0]).length;
					a >= f && $($("p", i[0])[0]).remove(), n.append(o), o.animate({
						opacity: 1
					}, 600)
				}
				...
				isNaN(f) && (f = 250), s.$on("clearWait", function(e, t) {
					...
					if (0 == $("#" + i.key, c[0]).length || $("#" + i.key, c[0]).css("opacity") < 1) {
						...
						i.level > 0 ? l.css("z-index", s + i.level) : l.css("z-index", s + 1), c.append(l), i.logo && l.addClass("with-logo"), l.css("bottom", -(l.height() + 10)), l.animate({
							bottom: 0
						}, f, easings.easeOut), i.userDismissable && l.bind("click", function() {
							var e = $(this);
							e.animate({
								opacity: 0
							}, u, "linear", function() {
...
! function(e, t, n) {
	...
	function o(e, t, n, r) {
		var i = ["opacity", t, ~~ (100 * e), n, r].join("-"),
			...
			c = s && "-" + s + "-" || "";
		p[i] || (h.insertRule("@" + c + "keyframes " + i + "{0%{opacity:" + a + "}" + o + "%{opacity:" + e + "}" + (o + .01) + "%{opacity:1}" + (o + t) % 100 + "%{opacity:" + e + "}100%{opacity:" + a + "}}", h.cssRules.length), p[i] = 1);
		return i;
	}
	...
	u.defaults = {}, c(u.prototype, {
		spin: function(e) {
			...
			e && (e.insertBefore(a, e.firstChild || null), n = l(e), t = l(a), s(a, {
		...
		stop: function() {
			var e = this.el;
			e && (clearTimeout(this.timeout), e.parentNode && e.parentNode.removeChild(e), this.el = n);
			return this;
		},
		lines: function(e, t) {
			function n(e, n) {
...
! function(e, t) {
	...
	function F(e, t) {
		function n() {
			var a = arguments,
				s = t;
			i || (e = t[r]);
			o.length && (a = a.length ? Qt.apply(o, a) : o);
			if (this instanceof n) {
				l.prototype = e.prototype, s = new l;
				var c = e.apply(s, a);
				return zt[typeof c] && null !== c ? c : s
			}
			return e.apply(s, a)
		}
	...
	function J(e) {
		...
		return function() {
			var r, i = arguments;
			i.length && (t.length = n, Zt.apply(t, i));
			r = 1 == t.length ? e.call(this, t[0]) : e.apply(this, t);
			t.length = n;
			return r;
		}
	}
	...
	function G(e, t) {
		return function() {
			var n = [e];
			arguments.length && Zt.apply(n, arguments);
			return t.apply(this, n);
		}
	}

	function K(e) {
		return zt[typeof e] && null !== e ? qn(e) ? e.slice() : An({}, e) : e
	}
	...
	function mt(e) {
		wn(jn(e), function(t) {
			...
			r.prototype[t] = function() {
				...
				var t = i.apply(n, e);
				this._chain && (t = new r(t), t._chain = true);
				return t;
			}
		})
	}
	...
	n.VERSION = "0.3.1", n.after = P, n.bind = F, n.bindAll = z, n.chain = kt, n.clone = K, n.compact = g, n.compose = R, n.contains = vn, n.debounce = H, n.defaults = Sn, n.defer = U, n.delay = B, n.difference = m, n.escape = ht, n.every = yn, n.extend = An, n.filter = bn, n.find = $n, n.first = v, n.flatten = y, n.forEach = wn, n.forIn = En, n.forOwn = Nn, n.functions = jn, n.groupBy = b, n.has = Q, n.identity = gt, n.indexOf = $, n.initial = w, n.intersection = k, n.invoke = x, n.isArguments = _n, n.isArray = qn, n.isBoolean = Y, n.isDate = Z, n.isElement = et, n.isEmpty = Mn, n.isEqual = tt, n.isFinite = nt, n.isFunction = rt, n.isNaN = ot, n.isNull = at, n.isNumber = st, n.isObject = it, n.isRegExp = ct, n.isString = lt, n.isUndefined = ut, n.keys = On, n.last = T, n.lastIndexOf = C, n.map = kn, n.max = S, n.memoize = W, n.min = A, n.mixin = mt, n.noConflict = vt, n.once = V, n.partial = J, n.pick = ft, n.pluck = E, n.range = N, n.reduce = xn, n.reduceRight = p, n.reject = Tn, n.rest = j, n.result = yt, n.shuffle = _, n.size = dt, n.some = Cn, n.sortBy = q, n.sortedIndex = M, n.tap = pt, n.template = bt, n.throttle = X, n.times = $t, n.toArray = h, n.union = O, n.uniq = I, n.uniqueId = wt, n.values = In, n.without = D, n.wrap = G, n.zip = L, n.all = yn, n.any = Cn, n.collect = kn, n.detect = $n, n.each = wn, n.foldl = xn, n.foldr = p, n.head = v, n.include = vn, n.inject = xn, n.methods = jn, n.select = bn, n.tail = j, n.take = v, n.unique = I, n._iteratorTemplate = ln, n._shimKeys = mn, r.prototype = n.prototype, mt(n), r.prototype.chain = xt, r.prototype.value = Tt, wn(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function(e) {
		...
		r.prototype[e] = function() {
			var e = this._wrapped;
			t.apply(e, arguments);
			0 === e.length && delete e[0];
			this._chain && (e = new r(e), e._chain = true);
			return e;
		}
		...
		r.prototype[e] = function() {
			...
			this._chain && (n = new r(n), n._chain = true);
			return n;
		}
...
! function(e, t) {
	...
	function f(e, t, i, o, a, s) {
		function c(e) {
			var n = e - h;
			return n > f || g ? (s = isFinite(s) ? s : 1, g ? v && t(s) : t(s), r(c), i && i.apply(d)) : void t(isFinite(s) ? p * o(n / f) + a : o(n / f))
		}
...
appCtrl.loadContent = function(e, t, n, r) {
	window.device && navigator.splashscreen.hide();
	n.defer = e.defer();
